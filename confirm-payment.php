  ...
  <section class="wrapper">
    <div id="container">
      ...
      <div id="content">
        ...
        <div class="breadcrumb"> <a href="cart.html">Shopping Cart</a> » <a href="checkout.html">Checkout</a></div>
        <!--Breadcrumb Part End-->
        <h1>Checkout</h1>
    <div class="checkout" style="text-align: center; background-color: #green;">
      <form action='status.php' method='POST'>
      <div class="card__container">
          <div class="card">
              <div class="row">
                <img src="image/mpesa/mpesa1.png" style="width:10%;margin: 0 35%;">
                <p style="color:#8F92C3;line-height:1.7;">3. After receiving <b>"Payment Confirmation Message"</b> press <b>"Confirm Payment"</b> to finish your transaction.</p>     
              </div>
          </div>
      </div>
      <div class="button">
    ...
    <div class="line-bottom">
      <div id="customHome" class="container_12">
        <div id="about_us_footer" class="grid_3">
          ...
          <p>Instore is Kenya's no. 1 on line retailer, was established in May 2020 with the aim and vision to become the one-stop shop for retail in Kenya with implementation of best practices both on line and off line..<br/>At inception we did an average delivery time of a week, today we do, on average, delivery in 1-5 days</p>
        </div>
        <!--  TWITTER -->
